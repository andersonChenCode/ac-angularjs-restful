...
public class TimeUtil {
	...
	public final static String FRIENDLY_TO_THE_MILLIS_FORMAT1 = "YYYY/MM/DD HHmmSS";
	public final static String MYSQL_FORMAT = "YYYY-MM-DD HH:mm:SS";
	...
	public static String parseToString(Date date,String format) {
		...
		else if (format.equals(MYSQL_FORMAT)){
	...
	public static Date parseToDate(String dateString,String format) {
		...
		if(format.equals(FRIENDLY_TO_THE_SECOND_FORMAT)) {
			...
			calendar.set(Calendar.SECOND, Integer.parseInt(SS));
			calendar.set(Calendar.MILLISECOND, Integer.parseInt(sss));				
		}else if (format.equals(FRIENDLY_TO_THE_MILLIS_FORMAT1)){

			String YYYY = dateString.substring(0,4);
			String MM = dateString.substring(5,7);
			String DD = dateString.substring(8,10);

			String timeString = dateString.substring(11).replace(" ", "").trim();
			
			String HH = timeString.substring(0,2);
			String mm = timeString.substring(3,5);
			String SS = timeString.substring(6,8);
