...
import com.util.io.FileWriteOption;
...
public class FileWrite {
    ...
    public static void stringToFile(String text, File outputFile) throws IOException {
    	...
    	fileWriteOption.setIsAppend(new Boolean(false));
	...
	public static void forceWritable(File file) throws IOException, InterruptedException {
		Process process = Runtime.getRuntime().exec("attrib -r " + file.getAbsolutePath());
		process.waitFor();
	}
