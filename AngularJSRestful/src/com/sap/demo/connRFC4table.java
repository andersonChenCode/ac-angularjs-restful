...
public class connRFC4table {
	public static void main(String[] args) throws JCoException {
		
		SapSystem sapSystem = SapUtilities.getLocalDefTestSystem();
    	Object[] obj = SapUtilities.getJCoFunction(sapSystem,"YFIRFC_GETVOUCHERUSETABLE");
		...
		JCoTable T_BKPF = function.getTableParameterList().getTable("T_BKPF");
		
	    for (int i = 0; i < T_BKPF.getNumRows(); i++){ 
	    	T_BKPF.setRow(i); 
	    	 String BUKRS = T_BKPF.getString("BUKRS");
	    	 String GJAHR = T_BKPF.getString("GJAHR");
	    	 String BELNR = T_BKPF.getString("BELNR");
	    	 System.out.println(BUKRS +"   " + GJAHR + "  " + BELNR );
	    }
