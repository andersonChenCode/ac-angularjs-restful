...
public class SapSystem implements java.lang.Cloneable {
	...
	private final String language; // English will be used as login language 
	...
	public SapSystem(String name, String host, String client
			 , String systemNumber, String user, String password , String language ) {
				this.name = name;
				this.client = client;
				this.user = user;
	...
	public SapSystem(String name, String host, String client
			 , String systemNumber, String user, String password , String language ,String JCO_SAPROUTER) {
				this.name = name;
				this.client = client;
				this.user = user;
				this.password = password;
