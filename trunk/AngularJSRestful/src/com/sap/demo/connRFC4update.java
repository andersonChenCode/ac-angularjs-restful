...
public class connRFC4update {

	public static void main(String[] args) throws JCoException {
		
		SapSystem sapSystem = SapUtilities.getLocalDefTestSystem();
    	Object[] obj = SapUtilities.getJCoFunction(sapSystem,"YFIRFC_UPDATE_VOUCHER_XREF1_HD");
    	...
    	function.getImportParameterList().setValue("BELNR", "4900000054");
